    ...
    return (
        <div className="min-h-screen py-1 px-4 flex flex-col">
            <div className="max-w-7xl mx-auto flex-1 flex flex-col w-full">
                ...
                {/* Tabs Navigation */}
                <div
                    className="mb-3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-2 inline-flex gap-2 mx-auto"
                ...
                <div className="flex-1">
                    <div className={activeTab === "invoice" ? "block animate-fadeIn" : "hidden"}>
                        <InvoiceProcessor
                            licenseIdsToLoad={licenseIdsToLoad}
                            onLoadComplete={() => setLicenseIdsToLoad([])}
                            caseNumberToLoad={caseNumber}
                        />
                    </div>
                    ...
                    <div className={activeTab === "search" ? "block animate-fadeIn" : "hidden"}>
                        <div className="mb-8">
                            <h2 className="text-2xl font-bold text-center text-gray-700 mb-4 font-hebrew">
                                חיפוש במאגר הקיים
                            </h2>
                        ...
                        {/* Search Results */}
                        <SearchResults licenses={licenses} isLoading={isLoading} hasSearched={hasSearched} />
                    </div>

                    <div className={activeTab === "history" ? "block animate-fadeIn" : "hidden"}>
                        <History
                            historyRenderKey={historyRenderKey}
